...
import ca.mcgill.ecse321.EventRegistrationBackend.service.EventRegistrationBackendService;

@CrossOrigin(origins = "*")
@RestController
public class EventRegistrationBackendRestController {

	@Autowired
	private EventRegistrationBackendService service;
	...
	throws IllegalArgumentException {
		Event event = service.createEvent(name, (java.sql.Date) date, Time.valueOf(startTime), Time.valueOf(endTime));
